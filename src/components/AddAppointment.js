...
const AddAppointment = ({ onSendAppointment, lastId }) => {
  ...
  // useState initializes a false value for now
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input
                ...
                id="ownerName"
                onChange={(event) => {
                  // on change, addes the owner name in the form data, but not overrides all the form
...
// Appointments Component JSX obtained from https://lnkd.in/gp3bUX7
